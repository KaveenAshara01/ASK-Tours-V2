      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          <a
            ...
            className="bg-green-500 hover:bg-green-600 p-6 md:p-8 rounded-xl transition-all duration-300 transform hover:scale-105 active:scale-95 shadow-xl group"
          >
            <div className="flex flex-col items-center">
              <svg className="w-12 h-12 md:w-16 md:h-16 mb-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <p className="mt-2 font-semibold text-sm md:text-base">{whatsappNumber}</p>
            </div>
          </a>

          <a
            href={`mailto:${email}?subject=Tourism Package Inquiry`}
            className="bg-primary-600 hover:bg-primary-700 p-6 md:p-8 rounded-xl transition-all duration-300 transform hover:scale-105 active:scale-95 shadow-xl group"
          >
            <div className="flex flex-col items-center">
              ...
              <p className="mt-2 font-semibold break-all text-sm md:text-base">{email}</p>
            </div>
          </a>
        </div>
      </div>
